    ...
    <div className="min-h-screen flex items-center justify-center bg-background px-4 selection:bg-primary/20">
      ...
      <div className="relative w-full max-w-md bg-card border border-border rounded-3xl p-8 shadow-2xl shadow-indigo-950/30">
        ...
        <div className="flex flex-col items-center mb-10">
          ...
          <h1 className="text-xl font-black text-foreground tracking-tight leading-none text-center">Register Citizen</h1>
          <p className="text-[10px] text-muted-foreground mt-2 font-bold uppercase tracking-wider">Create a Complaint Tracking Account</p>
        </div>
        ...
        <div className="space-y-6">
          <p className="text-center text-xs text-muted-foreground leading-relaxed px-4">
            Create an account securely using your Google account to log and track public safety complaints.
          </p>
